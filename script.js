...
class Arc extends Shape {
    constructor(name, x, y, radius, radians) {
        super(name);
...
class BezierSegment {
    constructor(name, x0, y0, x1, y1, width) {
        this.name = name;

        //  Create line and nodes
        this.line = new Rectangle(name + '_L',x0,y0,x1,y1,width,0);
        this.headNode = new Arc(name + '_N0', x0, y0, width, Math.PI * 2);
        this.tailNode = new Arc(name + '_N1', x1, y1, width, Math.PI * 2);
    }   
